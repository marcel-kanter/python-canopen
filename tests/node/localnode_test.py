...
class LocalNodeTestCase(unittest.TestCase):
	...
	def test_data_access(self):
		...
		dictionary["rec"]["integer32"].default = 0x55AA
		dictionary["var"].default = 0xCAFE
		...
		self.assertEqual(examinee.get_data(0x1234, 0x04), dictionary["rec"]["integer32"].default)
		...
		dictionary["rec"]["integer32"].default = 0xAA55
		self.assertEqual(examinee.get_data(0x1234, 0x04), dictionary["rec"]["integer32"].default)
		...
		self.assertEqual(examinee.get_data(0x5678, 0x00), dictionary["var"].default)
