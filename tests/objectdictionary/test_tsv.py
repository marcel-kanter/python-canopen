...
class TSVTest(unittest.TestCase):
	def setUp(self):
		...
		dictionary["Identity object"].add(canopen.objectdictionary.Variable("Vendor-ID", 0x1018, 0x01, canopen.objectdictionary.UNSIGNED32, "ro"))
		dictionary["Identity object"].add(canopen.objectdictionary.Variable("Product code", 0x1018, 0x02, canopen.objectdictionary.UNSIGNED32, "ro"))
		dictionary["Identity object"].add(canopen.objectdictionary.Variable("Revision number", 0x1018, 0x03, canopen.objectdictionary.UNSIGNED32, "ro"))
		dictionary["Identity object"].add(canopen.objectdictionary.Variable("Serial number", 0x1018, 0x04, canopen.objectdictionary.UNSIGNED32, "ro"))
